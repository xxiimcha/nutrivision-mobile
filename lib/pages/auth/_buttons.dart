      ...
      onPressed: () async {
        if (_formKey.currentState!.validate()) {
          try {
            ...
            debugPrint('Response: $response'); // Log the response
            ...
            debugPrint('Error: $e'); // Log the error
            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
...
class _LoginButtonState extends State<LoginButton> {
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
              ...
              if (widget._formKey.currentState!.validate()) {
                ...
                try {
                  final response = await httpService.login(
                    widget.usernameOrEmailController.text,
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor: const Color(0xFF0000FF), // Replace with your theme color
      ),
      child: isLoading
