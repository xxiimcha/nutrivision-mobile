...
class PatientDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Patient Details", style: TextStyle(color: Colors.white, fontSize: 20)),
      ...
      body: Padding(
        ...
        child: ListView(
            children: [
              ...
              _buildDetailCard(Icons.warning_amber, 'Food Allergies', patient.foodAllergy ?? 'None'), // ✅ Added line
            ],
          ),
      ),
    );
